...
let digitsRefreshIntervalId = null; //interval ID for displaying the digits
...
btnLeftElement.addEventListener('click', () => {
  ...
  if (btnLeftElement.innerText === 'START') {
    ...
    if (!digitsRefreshIntervalId) {
      digitsRefreshIntervalId = setInterval(() => printTime(), 1000); // This is protected frm multiple starts
    }
    setStopBtn();
    setSplitBtn();
  } else {
