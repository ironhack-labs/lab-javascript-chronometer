...
function printTime() {
    ...
    minUni.innerText = min.substring(1, 2)
...
function printMilliseconds() {
    ...
    milDec.innerText = miliSeconds.substring(0, 1)
    milUni.innerText = miliSeconds.substring(1, 2)
}
...
function printSplit() {
    ...
    li.innerText = `${time.min}:${time.sec}:${time.miliSec}`
