describe("Chronometer", () => {
  ...
  describe("splitClick method", () => {
    ...
    it("should return valid format with minutes and seconds, when minutes and seconds are a single digit numbers", () => {
      const chronometer = new Chronometer();
      chronometer.currentTime = 61;
    ...
    it("should return valid format with minutes and seconds, when both minutes and seconds are a two digit numbers", () => {
      const chronometer = new Chronometer();
      chronometer.currentTime = 620;
    ...
    it("should return valid format with minutes and seconds, when minutes are a single digit number", () => {
      const chronometer = new Chronometer();
      chronometer.currentTime = 599;
    ...
    it("should return valid format with minutes and seconds, when seconds are a single digit number", () => {
      const chronometer = new Chronometer();
      chronometer.currentTime = 601;
